...
unzip -o $file -d /Volumes/BACKUPS/World\ of\ Warcraft/Interface/Addons/
fi

cd /Volumes/BACKUPS/World\ of\ Warcraft/Interface/Addons/ElvUI.git
git checkout -- .
git pull

/Volumes/BACKUPS/World\ of\ Warcraft/World\ of\ Warcraft-64.app/Contents/MacOS/World\ of\ Warcraft-64
